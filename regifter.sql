...
-- 
\echo Insert a pine candle, given by 'Santa' thats price is 9 and has been previously regifted
-- 

INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES 
('pine candle', 'Santa', 9, true);
...
--
 ...
 INSERT INTO gifts (gift, giver, price, previously_regifted)
 VALUES
('vanilla candle', 'Mrs. Claus', '8', FALSE),
('cinnamon sugar', 'Frosty', '7', TRUE),
('sugar cookies', 'Dasher', '12', FALSE),
('candy cane', 'Dancer', '12', FALSE),
('bag of coal', 'Vixen', '37', TRUE);
