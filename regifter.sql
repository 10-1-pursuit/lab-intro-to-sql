...
-- 
INSERT INTO gifts (gift, giver, price, previously_gifted)
...
('potpouri', 'Elf on the Shelf', '39', TRUE),
...
INSERT INTO gifts (gift, giver, price, previously_gifted)
 VALUES
    ('pine candle', 'Mrs. Claus', '8', FALSE),
    ('christmas snow globe', 'Dasher', '15', FALSE),
    ('fruit cake', 'Dancer', '2', TRUE),
    ('roasted chestnuts', 'Prancer', '20', FALSE),
    ('candy canes', 'Vixen', '10', TRUE)
    ;
