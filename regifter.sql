...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('beeswax', 'Jameel', '99', TRUE),
('wood wick candle', 'Carlos', '89', TRUE),
('soy', 'Chris', '69', FALSE),
('floating', 'Destiny', '59', TRUE),
('taper', 'Anthony', '79', FALSE)
;
...
-- 
SELECT COUNT(price) FROM gifts WHERE gift LIKE '%candle%';
