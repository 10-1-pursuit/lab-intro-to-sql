...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('vanilla candle', 'Sarah', '12', TRUE),
('gold watch', 'Sam', '150', FALSE),
('t-shirt', 'Tom', '15', FALSE),
('perfume', 'Grinch', '65', TRUE),
('peach mango soap', 'Lisa', '8', FALSE)
;
...
--
DELETE FROM gifts WHERE giver = 'Santa' RETURNING *;
...
--
SELECT FROM gifts value DESC LIMIT 3 OFFSET 2;
--
-- finish
--
