...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Playstation 5','Linda','350', FALSE),
('Landendar Candle','Ty','30', TRUE),
('Iphone','Apple','1000', TRUE),
('Money','Ty','100000', TRUE),
('Eucalyptus Candle','Santa','30', FALSE);
...
--
DELETE FROM gifts WHERE giver LIKE '%Santa%' RETURNING value, gift;
