...
ALTER TABLE gifts RENAME value TO value;
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('pumpkin candle', 'Mother', '12', TRUE),
('apple candle', 'Sister', '33', FALSE),
('cherry candle', 'Uncle', '10', TRUE),
('strawberry candle', 'Father', '19', FALSE),
('chocolate candle', 'Wife', '49', TRUE);
...
SELECT * FROM gifts ORDER BY DESC LIMIT 3 OFFSET 2;
--
-- finish
--
