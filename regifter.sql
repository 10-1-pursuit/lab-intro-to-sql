...
INSERT INTO gifts 
    (gift, giver, value, previously_regifted)
VALUES
    ('citrus candle', 'Apt 16C', 10, FALSE),
    ('apple pie', 'Apt 16C', 10, FALSE),
    ('bottle Don Julio', 'Apt 10D', 170, FALSE),
    ('bottle of ketel one', 'Apt 6A', 30, FALSE),
    ('welcome mat', 'doorman', 20, TRUE);
