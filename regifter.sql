...
CREATE TABLE gifts ( id SERIAL PRIMARY KEY, gift TEXT NOT NULL, giver TEXT NOT NULL, price INT, previously_regifted BOOLEAN);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('life candle', 'Michael', 7, TRUE),
('direct candle', 'Peter', 14, TRUE),
('blinded by the light', 'Paul', 14, FALSE),
('virgin rose', 'Mary', 2, TRUE),
('message candle', 'Gabe', 777, FALSE),
('help candle', 'john', 17, TRUE)
;
--
...
--
SELECT gift FROM gifts ORDER BY gift LIKE '%candle%';
--
...
-- 
SELECT SUM(gift) FROM gifts ORDER BY gift LIKE '%candle%';
--
