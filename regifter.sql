...
CREATE
regifter=#  TABLE gifts ( id SERIAL PRIMARY KEY, gift TEXT, giver TEXT, value INTEGER, previously_regifted BOOLEAN);
...
--
 INSERT INTO gifts (gift, giver, price, previously_regifted)
 VALUES
 ('peach candle', 'Santa', '20', TRUE),
  ('ugly sweater', 'John', '50', FALSE),
 ('play station4', 'Jonas', '35', TRUE),
 ('jordan sneaker', 'Michael', '150', TRUE),
 ('lavender candle', 'Max', '22', FALSE)
 ;
...
--
SELECT * FROM gifts WHERRE price >= 20;
...
--
SELECT * FROM gifts WHERE giver ILIKE 'santa' OR price > 30;
