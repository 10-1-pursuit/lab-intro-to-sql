...
(gift, giver, price, previously_regifted)
VALUES
('Macbook Air', 'Kavon', '999', TRUE),
('cinnamon toast crunch', 'Nicki', '29', TRUE),
('rifle on a scope', 'Adolf', '329', FALSE),
('pot just pot', 'Elf on the grower', '19', TRUE),
('mangos', 'Big Bob', '88', FALSE);
