...
-- 
Value is already input when the table was first created. No change is necessary. 
ALTER TABLE gifts
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Canoli candle', 'Italian Baker', 7, TRUE),
('Yankee candle', 'Steinbrenner', 28, TRUE),
('Homemade Lasagna candle', 'My Mamma', 48, FALSE),
('Celsius Sparkling Orange', 'Organic Deli', 22, TRUE),
('Body Odor Candle', 'Not so Fresh', 1, FALSE)
;
